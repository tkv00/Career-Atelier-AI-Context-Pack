  ...
  return <>
    ...
    <div className="calendar-workspace">
      <section className="calendar-board">
        <div className="calendar-head"><div><span>MISSION MONTH</span><h3>{month.getFullYear()}년 {month.getMonth() + 1}월</h3></div><div><button onClick={() => setMonth(new Date(month.getFullYear(), month.getMonth() - 1, 1))}>‹</button><button onClick={() => setMonth(new Date(now.getFullYear(), now.getMonth(), 1))}>오늘</button><button onClick={() => setMonth(new Date(month.getFullYear(), month.getMonth() + 1, 1))}>›</button></div></div>
