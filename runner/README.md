...
- 웹에서 먼저 본인 계정을 만드세요. 설치 마법사는 임시 서비스 비밀번호를 발급하지 않습니다. Supabase DB 비밀번호나 웹 URL을 입력하지 마세요.
- 비밀번호 입력은 숨겨지며 앞뒤 공백도 그대로 보존합니다. 웹과 러너의 프로젝트가 다르면 로그인 전에 설정 확인을 안내합니다.
